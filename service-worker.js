const CACHE_NAME='packers-central-v4';
const ASSETS=['./','./index.html','./schedule.html','./season.html','./styles.css','./news-media.css','./mockup-match.css','./season.css','./app.js','./schedule.js','./season.js','./data/news.json','./data/schedule.json','./data/season.json','./manifest.webmanifest','./icon.svg'];
