const CACHE_NAME='packers-central-v3';
const ASSETS=['./','./index.html','./schedule.html','./season.html','./styles.css','./season.css','./app.js','./schedule.js','./season.js','./data/schedule.json','./data/season.json','./manifest.webmanifest','./icon.svg'];
